...
//        http.authorizeRequests().antMatchers(GET, "/api/appuser/**").hasAnyAuthority("ROLE_USER");
//        http.authorizeRequests().antMatchers(POST, "/api/appuser/save/**").hasAnyAuthority("ROLE_ADMIN");
